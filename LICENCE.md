# Burghley Scan - Business Source License
...
- **"License"** means the rights and conditions set out in this document.
- **"Licensor"** means Burghley AI Services Limited (or successor entity).
- **"You"** means any individual or organisation exercising rights granted by this License.
- **"Software"** means the burghley-scan codebase and all materials in the repository, including source code, documentation, and configuration files.
...
- Running the Software for auditing Your own codebase;
- Running the Software for educational or research purposes;
- Contributing improvements back to the official repository;
